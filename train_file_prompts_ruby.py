...
""",
    """\
Consider the following task: {task}. How to implement that in ruby?
...
""",    
    """\
This is my current task: {task}. I need a ruby code that will guide me on how to implement it in the final production code. I intend to copy most of your answer if possible.
""",
    """\
{task}
